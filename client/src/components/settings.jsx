...
const SettingsComponent =({user})=> { 
    // const [form,setForm] = useState({photo:'',username:user.username,password:'',confirmpassword:'',firstname:user.firstname,lastname:user.lastname,email:user.email}) 
  ...
  function submit(e){
    ...
    return(
        <div className="settingsComp" style={{width:'73%'}}>
            ...
            <button style={{margin:'0px auto',width:'80px',height:'30px' ,fontSize:'14px',borderRadius:'20px',backgroundColor:'transparent',borderColor:'none'}} type='submit'>Submit</button>
            </div>
